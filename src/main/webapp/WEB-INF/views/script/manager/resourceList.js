...
function onChangeFilter() {
    ...
    if (selected === 'resourceList') {
        ...
        history.pushState(null, null, '/manager/resourceList.html?idProject=' + idPr + '&idEmployee=' + idEmpl);
        updateResourceList();
    } else if (selected === 'projectStatistic') {
        idPr = document.getElementById('projectList').value;
        history.pushState(null, null, '/manager/resourceList.html?idProject=' + idPr);
        updateProjectStatistic();
    } else if (selected === 'sprintStatistic') {
        idPr = document.getElementById('projectList').value;
        history.pushState(null, null, '/manager/resourceList.html?idSprint=' + idPr);
...
function updateResourceList() {
    ...
    $.ajax({
        ...
        url: "/manager/resources?idProject=" + idPr + "&idEmployee=" + idEmpl,
        timeout: 100000,
        async: false,
...
function getEmployee() {
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json",
        url: "/manager/employees?idProject=" + projectId,
        timeout: 100000,
        success: function (data) {
            if (data != null) {
...
function updateProjectStatistic() {
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json",
        url: "/manager/projectStatistic?idProject=" + idPr,
        timeout: 100000,
        async: false,
        success: function (data) {
            if (data == null) {
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json",
        url: "/manager/projectStatisticDashboard?idProject=" + idPr,
        timeout: 100000,
        async: false,
        success: function (data) {
            if (data == null) {
...
function updateSprintStatistic() {
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json",
        url: "/manager/sprintStatistic?idSprint=" + idSpr,
        timeout: 100000,
        async: false,
        success: function (data) {
            if (data == null) {
    ...
    $.ajax({
        type: "GET",
        contentType: "application/json",
        url: "/manager/sprintStatisticDashboard?idSprint=" + idSpr,
        timeout: 100000,
        async: false,
        success: function (data) {
            if (data == null) {
